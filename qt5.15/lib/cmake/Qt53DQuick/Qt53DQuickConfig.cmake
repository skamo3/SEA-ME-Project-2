...
set(Qt53DQuick_VERSION_STRING 5.15.0)
...
if (NOT TARGET Qt5::3DQuick)
    ...
    set(Qt53DQuick_PRIVATE_INCLUDE_DIRS
        "${_qt53DQuick_install_prefix}/include/Qt3DQuick/5.15.0"
        "${_qt53DQuick_install_prefix}/include/Qt3DQuick/5.15.0/Qt3DQuick"
    )
    ...
    foreach(_module_dep ${_Qt53DQuick_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.0 ${_Qt53DQuick_FIND_VERSION_EXACT}
    ...
    if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND NOT TARGET Qt::3DQuick)
    ...
    _populate_3DQuick_target_properties(RELEASE "libQt53DQuick.so.5.15.0" "" FALSE)
