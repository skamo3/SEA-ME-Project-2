...
set(Qt5UiTools_VERSION_STRING 5.15.0)
...
if (NOT TARGET Qt5::UiTools)
    ...
    set(Qt5UiTools_PRIVATE_INCLUDE_DIRS
        "${_qt5UiTools_install_prefix}/include/QtUiTools/5.15.0"
        "${_qt5UiTools_install_prefix}/include/QtUiTools/5.15.0/QtUiTools"
    )
    ...
    foreach(_module_dep ${_Qt5UiTools_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.0 ${_Qt5UiTools_FIND_VERSION_EXACT}
    ...
    if(NOT Qt5_EXCLUDE_STATIC_DEPENDENCIES)
        ...
        _qt5_UiTools_process_prl_file(
            "${_qt5UiTools_install_prefix}/lib/libQt5UiTools.prl" RELEASE
    ...
    if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND NOT TARGET Qt::UiTools)
    ...
    set_property(TARGET Qt5::UiTools PROPERTY INTERFACE_QT_PLUGIN_TYPES "designer")
    ...
    _populate_UiTools_target_properties(RELEASE "libQt5UiTools.a" "" FALSE)
