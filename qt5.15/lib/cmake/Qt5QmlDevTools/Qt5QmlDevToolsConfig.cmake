...
set(Qt5QmlDevTools_VERSION_STRING 5.15.0)
...
if (NOT TARGET Qt5::QmlDevTools)
    ...
    set(Qt5QmlDevTools_PRIVATE_INCLUDE_DIRS
        "${_qt5QmlDevTools_install_prefix}/include/QtQml/5.15.0"
        "${_qt5QmlDevTools_install_prefix}/include/QtQml/5.15.0/QtQml"
    )
    ...
    set(_Qt5QmlDevTools_MODULE_DEPENDENCIES "Bootstrap")
    ...
    foreach(_module_dep ${_Qt5QmlDevTools_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.0 ${_Qt5QmlDevTools_FIND_VERSION_EXACT}
    ...
    set(_Qt5QmlDevTools_LIB_DEPENDENCIES "Qt5::Bootstrap")
    ...
    if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND NOT TARGET Qt::QmlDevTools)
