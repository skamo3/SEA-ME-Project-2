...
set(Qt53DQuickAnimation_VERSION_STRING 5.15.0)
...
if (NOT TARGET Qt5::3DQuickAnimation)
    ...
    set(Qt53DQuickAnimation_PRIVATE_INCLUDE_DIRS
        "${_qt53DQuickAnimation_install_prefix}/include/Qt3DQuickAnimation/5.15.0"
        "${_qt53DQuickAnimation_install_prefix}/include/Qt3DQuickAnimation/5.15.0/Qt3DQuickAnimation"
    )
    ...
    foreach(_module_dep ${_Qt53DQuickAnimation_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.0 ${_Qt53DQuickAnimation_FIND_VERSION_EXACT}
    ...
    if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND NOT TARGET Qt::3DQuickAnimation)
    ...
    _populate_3DQuickAnimation_target_properties(RELEASE "libQt53DQuickAnimation.so.5.15.0" "" FALSE)
