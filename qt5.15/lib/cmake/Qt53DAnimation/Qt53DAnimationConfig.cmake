...
set(Qt53DAnimation_VERSION_STRING 5.15.0)
...
if (NOT TARGET Qt5::3DAnimation)
    ...
    set(Qt53DAnimation_PRIVATE_INCLUDE_DIRS
        "${_qt53DAnimation_install_prefix}/include/Qt3DAnimation/5.15.0"
        "${_qt53DAnimation_install_prefix}/include/Qt3DAnimation/5.15.0/Qt3DAnimation"
    )
    ...
    foreach(_module_dep ${_Qt53DAnimation_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.0 ${_Qt53DAnimation_FIND_VERSION_EXACT}
    ...
    if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND NOT TARGET Qt::3DAnimation)
    ...
    _populate_3DAnimation_target_properties(RELEASE "libQt53DAnimation.so.5.15.0" "" FALSE)
