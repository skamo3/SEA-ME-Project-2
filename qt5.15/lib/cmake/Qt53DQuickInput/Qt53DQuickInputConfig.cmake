...
set(Qt53DQuickInput_VERSION_STRING 5.15.0)
...
if (NOT TARGET Qt5::3DQuickInput)
    ...
    set(Qt53DQuickInput_PRIVATE_INCLUDE_DIRS
        "${_qt53DQuickInput_install_prefix}/include/Qt3DQuickInput/5.15.0"
        "${_qt53DQuickInput_install_prefix}/include/Qt3DQuickInput/5.15.0/Qt3DQuickInput"
    )
    ...
    foreach(_module_dep ${_Qt53DQuickInput_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.0 ${_Qt53DQuickInput_FIND_VERSION_EXACT}
    ...
    if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND NOT TARGET Qt::3DQuickInput)
    ...
    _populate_3DQuickInput_target_properties(RELEASE "libQt53DQuickInput.so.5.15.0" "" FALSE)
