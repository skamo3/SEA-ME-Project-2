...
set(Qt53DInput_VERSION_STRING 5.15.0)
...
if (NOT TARGET Qt5::3DInput)
    ...
    set(Qt53DInput_PRIVATE_INCLUDE_DIRS
        "${_qt53DInput_install_prefix}/include/Qt3DInput/5.15.0"
        "${_qt53DInput_install_prefix}/include/Qt3DInput/5.15.0/Qt3DInput"
    )
    ...
    foreach(_module_dep ${_Qt53DInput_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.0 ${_Qt53DInput_FIND_VERSION_EXACT}
    ...
    if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND NOT TARGET Qt::3DInput)
    ...
    _populate_3DInput_target_properties(RELEASE "libQt53DInput.so.5.15.0" "" FALSE)
