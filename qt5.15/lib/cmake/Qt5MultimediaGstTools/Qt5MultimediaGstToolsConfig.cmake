...
set(Qt5MultimediaGstTools_VERSION_STRING 5.15.0)
...
if (NOT TARGET Qt5::MultimediaGstTools)
    ...
    set(Qt5MultimediaGstTools_PRIVATE_INCLUDE_DIRS
        "${_qt5MultimediaGstTools_install_prefix}/include/QtMultimediaGstTools/5.15.0"
        "${_qt5MultimediaGstTools_install_prefix}/include/QtMultimediaGstTools/5.15.0/QtMultimediaGstTools"
    )
    ...
    set(_Qt5MultimediaGstTools_MODULE_DEPENDENCIES "Multimedia;Gui;Core;MultimediaWidgets")
    ...
    foreach(_module_dep ${_Qt5MultimediaGstTools_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.0 ${_Qt5MultimediaGstTools_FIND_VERSION_EXACT}
    ...
    set(_Qt5MultimediaGstTools_LIB_DEPENDENCIES "Qt5::Multimedia;Qt5::Gui;Qt5::Core;Qt5::MultimediaWidgets")


    add_library(Qt5::MultimediaGstTools SHARED IMPORTED)

    # Add a versionless target, for compatibility with Qt6.
    if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND NOT TARGET Qt::MultimediaGstTools)
        add_library(Qt::MultimediaGstTools INTERFACE IMPORTED)
        set_target_properties(Qt::MultimediaGstTools PROPERTIES
            INTERFACE_LINK_LIBRARIES "Qt5::MultimediaGstTools"
        )
    endif()
    ...
    set_property(TARGET Qt5::MultimediaGstTools
    ...
    if (_Qt5MultimediaGstTools_PRIVATE_DIRS_EXIST)
        ...
        # Add a versionless target, for compatibility with Qt6.
        if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND NOT TARGET Qt::MultimediaGstToolsPrivate)
            add_library(Qt::MultimediaGstToolsPrivate INTERFACE IMPORTED)
            set_target_properties(Qt::MultimediaGstToolsPrivate PROPERTIES
                INTERFACE_LINK_LIBRARIES "Qt5::MultimediaGstToolsPrivate"
            )
        endif()
    endif()

    _populate_MultimediaGstTools_target_properties(RELEASE "libQt5MultimediaGstTools.so.5.15.0" "" FALSE)
