...
set(Qt53DExtras_VERSION_STRING 5.15.0)
...
if (NOT TARGET Qt5::3DExtras)
    ...
    set(Qt53DExtras_PRIVATE_INCLUDE_DIRS
        "${_qt53DExtras_install_prefix}/include/Qt3DExtras/5.15.0"
        "${_qt53DExtras_install_prefix}/include/Qt3DExtras/5.15.0/Qt3DExtras"
    )
    ...
    foreach(_module_dep ${_Qt53DExtras_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.0 ${_Qt53DExtras_FIND_VERSION_EXACT}
    ...
    if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND NOT TARGET Qt::3DExtras)
    ...
    _populate_3DExtras_target_properties(RELEASE "libQt53DExtras.so.5.15.0" "" FALSE)
