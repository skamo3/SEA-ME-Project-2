...
set(Qt5MultimediaQuick_VERSION_STRING 5.15.0)
...
if (NOT TARGET Qt5::MultimediaQuick)
    ...
    set(Qt5MultimediaQuick_PRIVATE_INCLUDE_DIRS
        "${_qt5MultimediaQuick_install_prefix}/include/QtMultimediaQuick/5.15.0"
        "${_qt5MultimediaQuick_install_prefix}/include/QtMultimediaQuick/5.15.0/QtMultimediaQuick"
    )
    ...
    foreach(_module_dep ${_Qt5MultimediaQuick_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.0 ${_Qt5MultimediaQuick_FIND_VERSION_EXACT}
    ...
    if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND NOT TARGET Qt::MultimediaQuick)
    ...
    _populate_MultimediaQuick_target_properties(RELEASE "libQt5MultimediaQuick.so.5.15.0" "" FALSE)
