...
set(Qt5X11Extras_VERSION_STRING 5.15.0)
...
if (NOT TARGET Qt5::X11Extras)
    ...
    foreach(_module_dep ${_Qt5X11Extras_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.0 ${_Qt5X11Extras_FIND_VERSION_EXACT}
    ...
    if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND NOT TARGET Qt::X11Extras)
        add_library(Qt::X11Extras INTERFACE IMPORTED)
        set_target_properties(Qt::X11Extras PROPERTIES
            INTERFACE_LINK_LIBRARIES "Qt5::X11Extras"
        )
    endif()
    ...
    set_property(TARGET Qt5::X11Extras
    ...
    if (_Qt5X11Extras_PRIVATE_DIRS_EXIST)
        ...
        # Add a versionless target, for compatibility with Qt6.
        if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND NOT TARGET Qt::X11ExtrasPrivate)
            add_library(Qt::X11ExtrasPrivate INTERFACE IMPORTED)
            set_target_properties(Qt::X11ExtrasPrivate PROPERTIES
                INTERFACE_LINK_LIBRARIES "Qt5::X11ExtrasPrivate"
            )
        endif()
    endif()

    _populate_X11Extras_target_properties(RELEASE "libQt5X11Extras.so.5.15.0" "" FALSE)
    ...
    if (QT5_STRICT_PLUGIN_GLOB OR Qt5X11Extras_STRICT_PLUGIN_GLOB)
        file(GLOB pluginTargets "${CMAKE_CURRENT_LIST_DIR}/Qt5X11Extras_*Plugin.cmake")
    else()
        file(GLOB pluginTargets "${CMAKE_CURRENT_LIST_DIR}/Qt5X11Extras_*.cmake")
    endif()
