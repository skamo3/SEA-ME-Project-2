...
set(Qt5Quick3DRuntimeRender_VERSION_STRING 5.15.0)
...
macro(_populate_Quick3DRuntimeRender_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(imported_location "${_qt5Quick3DRuntimeRender_install_prefix}/lib/${LIB_LOCATION}")
    ...
    set_target_properties(Qt5::Quick3DRuntimeRender PROPERTIES
        ...
        "IMPORTED_SONAME_${Configuration}" "libQt5Quick3DRuntimeRender.so.5"
...
if (NOT TARGET Qt5::Quick3DRuntimeRender)
    ...
    set(Qt5Quick3DRuntimeRender_PRIVATE_INCLUDE_DIRS
        "${_qt5Quick3DRuntimeRender_install_prefix}/include/QtQuick3DRuntimeRender/5.15.0"
        "${_qt5Quick3DRuntimeRender_install_prefix}/include/QtQuick3DRuntimeRender/5.15.0/QtQuick3DRuntimeRender"
    )
    ...
    set(_Qt5Quick3DRuntimeRender_MODULE_DEPENDENCIES "Quick3DAssetImport;Quick3DRender;Quick3DUtils;Gui;Core")
    ...
    foreach(_module_dep ${_Qt5Quick3DRuntimeRender_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.0 ${_Qt5Quick3DRuntimeRender_FIND_VERSION_EXACT}
    ...
    set(_Qt5Quick3DRuntimeRender_LIB_DEPENDENCIES "Qt5::Quick3DAssetImport;Qt5::Quick3DRender;Qt5::Quick3DUtils;Qt5::Gui;Qt5::Core")


    add_library(Qt5::Quick3DRuntimeRender SHARED IMPORTED)

    # Add a versionless target, for compatibility with Qt6.
    if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND NOT TARGET Qt::Quick3DRuntimeRender)
    ...
    _populate_Quick3DRuntimeRender_target_properties(RELEASE "libQt5Quick3DRuntimeRender.so.5.15.0" "" FALSE)
