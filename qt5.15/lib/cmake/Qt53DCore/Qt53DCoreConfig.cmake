...
set(Qt53DCore_VERSION_STRING 5.15.0)
...
if (NOT TARGET Qt5::3DCore)
    ...
    set(Qt53DCore_PRIVATE_INCLUDE_DIRS
        "${_qt53DCore_install_prefix}/include/Qt3DCore/5.15.0"
        "${_qt53DCore_install_prefix}/include/Qt3DCore/5.15.0/Qt3DCore"
    )
    ...
    foreach(_module_dep ${_Qt53DCore_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.0 ${_Qt53DCore_FIND_VERSION_EXACT}
    ...
    if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND NOT TARGET Qt::3DCore)
    ...
    set_property(TARGET Qt5::3DCore
                 ...
                 qt3d-profile-gl;qt3d-profile-jobs;qt3d-simd-avx2;qt3d-simd-sse2;system-assimp)
    ...
    _populate_3DCore_target_properties(RELEASE "libQt53DCore.so.5.15.0" "" FALSE)
