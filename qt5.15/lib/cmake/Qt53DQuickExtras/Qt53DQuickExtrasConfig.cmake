...
set(Qt53DQuickExtras_VERSION_STRING 5.15.0)
...
if (NOT TARGET Qt5::3DQuickExtras)
    ...
    set(Qt53DQuickExtras_PRIVATE_INCLUDE_DIRS
        "${_qt53DQuickExtras_install_prefix}/include/Qt3DQuickExtras/5.15.0"
        "${_qt53DQuickExtras_install_prefix}/include/Qt3DQuickExtras/5.15.0/Qt3DQuickExtras"
    )
    ...
    foreach(_module_dep ${_Qt53DQuickExtras_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.0 ${_Qt53DQuickExtras_FIND_VERSION_EXACT}
    ...
    if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND NOT TARGET Qt::3DQuickExtras)
    ...
    _populate_3DQuickExtras_target_properties(RELEASE "libQt53DQuickExtras.so.5.15.0" "" FALSE)
