...
set(Qt5Quick3DAssetImport_VERSION_STRING 5.15.0)
...
macro(_populate_Quick3DAssetImport_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(imported_location "${_qt5Quick3DAssetImport_install_prefix}/lib/${LIB_LOCATION}")
    ...
    set_target_properties(Qt5::Quick3DAssetImport PROPERTIES
        ...
        "IMPORTED_SONAME_${Configuration}" "libQt5Quick3DAssetImport.so.5"
...
if (NOT TARGET Qt5::Quick3DAssetImport)
    ...
    set(_Qt5Quick3DAssetImport_OWN_INCLUDE_DIRS "${_qt5Quick3DAssetImport_install_prefix}/include/" "${_qt5Quick3DAssetImport_install_prefix}/include/QtQuick3DAssetImport")
    set(Qt5Quick3DAssetImport_PRIVATE_INCLUDE_DIRS
        "${_qt5Quick3DAssetImport_install_prefix}/include/QtQuick3DAssetImport/5.15.0"
        "${_qt5Quick3DAssetImport_install_prefix}/include/QtQuick3DAssetImport/5.15.0/QtQuick3DAssetImport"
    )
    ...
    foreach(_module_dep ${_Qt5Quick3DAssetImport_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.0 ${_Qt5Quick3DAssetImport_FIND_VERSION_EXACT}
    ...
    if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND NOT TARGET Qt::Quick3DAssetImport)
    ...
    _populate_Quick3DAssetImport_target_properties(RELEASE "libQt5Quick3DAssetImport.so.5.15.0" "" FALSE)
