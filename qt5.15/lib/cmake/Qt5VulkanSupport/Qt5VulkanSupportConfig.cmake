...
set(Qt5VulkanSupport_VERSION_STRING 5.15.0)
        ...
        foreach(_flag ${_static_depends})
            ...
            elseif(_framework_flag OR _flag MATCHES "^-l(.*)$")
                ...
                elseif(_lib MATCHES "^pthread$")
                    ...
                    find_library(_Qt5VulkanSupport_${Configuration}_${_lib}_PATH ${_lib} HINTS ${CMAKE_CXX_IMPLICIT_LINK_DIRECTORIES})
...
if (NOT TARGET Qt5::VulkanSupport)
    ...
    set(Qt5VulkanSupport_PRIVATE_INCLUDE_DIRS
        "${_qt5VulkanSupport_install_prefix}/include/QtVulkanSupport/5.15.0"
        "${_qt5VulkanSupport_install_prefix}/include/QtVulkanSupport/5.15.0/QtVulkanSupport"
    )
    ...
    foreach(_module_dep ${_Qt5VulkanSupport_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.0 ${_Qt5VulkanSupport_FIND_VERSION_EXACT}
    ...
    if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND NOT TARGET Qt::VulkanSupport)
        add_library(Qt::VulkanSupport INTERFACE IMPORTED)
        set_target_properties(Qt::VulkanSupport PROPERTIES
            INTERFACE_LINK_LIBRARIES "Qt5::VulkanSupport"
        )
    endif()
    ...
    set_property(TARGET Qt5::VulkanSupport
    ...
    if (_Qt5VulkanSupport_PRIVATE_DIRS_EXIST)
        ...
        # Add a versionless target, for compatibility with Qt6.
        if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND NOT TARGET Qt::VulkanSupportPrivate)
            add_library(Qt::VulkanSupportPrivate INTERFACE IMPORTED)
            set_target_properties(Qt::VulkanSupportPrivate PROPERTIES
                INTERFACE_LINK_LIBRARIES "Qt5::VulkanSupportPrivate"
            )
        endif()
    endif()
