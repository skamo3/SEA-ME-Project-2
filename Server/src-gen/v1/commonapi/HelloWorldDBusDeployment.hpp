...
#ifndef V1_COMMONAPI_Hello_World_DBUS_DEPLOYMENT_HPP_
#define V1_COMMONAPI_Hello_World_DBUS_DEPLOYMENT_HPP_
...
#endif // V1_COMMONAPI_Hello_World_DBUS_DEPLOYMENT_HPP_
