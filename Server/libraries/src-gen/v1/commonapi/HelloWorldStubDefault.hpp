...
public:
    ...
    COMMONAPI_EXPORT virtual void intDataMethod(const std::shared_ptr<CommonAPI::ClientId> _client, int32_t _parameter, intDataMethodReply_t _reply);
    COMMONAPI_EXPORT virtual void enumMethod(const std::shared_ptr<CommonAPI::ClientId> _client, HelloWorld::testEnum _testEnumParameter, enumMethodReply_t _reply);
    COMMONAPI_EXPORT virtual void structInMethod(const std::shared_ptr<CommonAPI::ClientId> _client, HelloWorld::testStruct _structParameter, structInMethodReply_t _reply);
    COMMONAPI_EXPORT virtual void structOutMethod(const std::shared_ptr<CommonAPI::ClientId> _client, int32_t _input, structOutMethodReply_t _reply);
