...
public:
    ...
    typedef std::function<void (int32_t _output)>intDataMethodReply_t;
    typedef std::function<void (int32_t _output)>enumMethodReply_t;
    typedef std::function<void (int32_t _output)>structInMethodReply_t;
    typedef std::function<void (HelloWorld::testStruct _structParameter)>structOutMethodReply_t;
    ...
    /// This is the method that will be called on remote calls on the method intDataMethod.
    virtual void intDataMethod(const std::shared_ptr<CommonAPI::ClientId> _client, int32_t _parameter, intDataMethodReply_t _reply) = 0;
    /// This is the method that will be called on remote calls on the method enumMethod.
    virtual void enumMethod(const std::shared_ptr<CommonAPI::ClientId> _client, HelloWorld::testEnum _testEnumParameter, enumMethodReply_t _reply) = 0;
    /// This is the method that will be called on remote calls on the method structInMethod.
    virtual void structInMethod(const std::shared_ptr<CommonAPI::ClientId> _client, HelloWorld::testStruct _structParameter, structInMethodReply_t _reply) = 0;
    /// This is the method that will be called on remote calls on the method structOutMethod.
    virtual void structOutMethod(const std::shared_ptr<CommonAPI::ClientId> _client, int32_t _input, structOutMethodReply_t _reply) = 0;
